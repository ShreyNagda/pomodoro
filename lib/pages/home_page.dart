...
class _HomePageState extends State<HomePage> {
  ...
  // final player = vlc.Player(id: 000, commandlineArguments: ['--no-video']);
  // final asset = vlc.Media.asset("assets/audio/bell.mp3");
  ...
  void initState() {
    setTimer();
    // player.open(asset, autoStart: true);
                          ...
                          CircleList(
                            ...
                            children: List.generate(
                              ...
                              (index) => Transform.rotate(
                                angle: radians(360 / timerModel.minutes * index)
                                    .toDouble(),
                                child: Container(
                                  height: width / 12.5,
                                  width: width / 25,
                                  decoration: BoxDecoration(
                                    color: (value.remaining / 60).ceil() > index
                                        ? Colors.white
                                        : Colors.white24,
